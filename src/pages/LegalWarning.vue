        ...
        <div class="container py-5 rounded-top-5 bg-white" style="margin-top: -40px;">
            <div class="card border-0">
                <div class="card-body text-start">
                    ...
                    <p>By accessing or using the website and services of Shashaktam Mindz, you agree to be bound by
                    ...
                    <p>All content on this website, including but not limited to text, graphics, logos, images, audio
                        clips, digital downloads, and software, is the property of Shashaktam Mindz or its content
                    ...
                    <p>Shashaktam Mindz and its affiliates shall not be liable for any direct, indirect, incidental,
                    ...
                    <p>Our website may contain links to third-party websites or services that are not owned or
                        controlled by Shashaktam Mindz. We have no control over, and assume no responsibility for,
                        the content, privacy policies, or practices of any third-party websites or services.</p>

                    <h2>6. Indemnification</h2>
                    <p>You agree to indemnify, defend, and hold harmless Shashaktam Mindz, its officers, directors,
                    ...
                    <p>Shashaktam Mindz<br>
                        Adv Noopur Singhal<br>
                        Email: noopur@sashaktammindz.com<br>
                        Phone: +919312765888<br>
                        Address: 20, Onward Workspaces, First Floor, Okhla Industrial Estate, Phase-3, New Delhi-110020
                    </p>
