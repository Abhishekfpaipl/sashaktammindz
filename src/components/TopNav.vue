<template>
    <div
      class="containerr d-flex justify-content-between align-items-center"
    ...
    >
      ...
      <div class="d-flex gap-5 align-items-center">
        <router-link
          :to="menu.path"
          class="d-lg-block d-none text-decoration-none text-dark"
          :class="{ 'border-bottom': $route.path === menu.path }"
        ...
        <i
          class="d-lg-none bi bi-list btn text-dark p-0 fs-4 px-1"
          data-bs-toggle="offcanvas"
          data-bs-target="#topMenuOffcanvas"
          aria-controls="topMenuOffcanvas"
    ...
    <div
      ...
      tabindex="-1"
      id="topMenuOffcanvas"
      aria-labelledby="topMenuOffcanvasLabel"
    ...
    >
      ...
      <div class="offcanvas-footer w-100 text-white">
        ...
        <div class="d-flex justify-content-evenly fs-2 w-100 gap-3">
          <a
            href="https://www.facebook.com/Ayush.Covisor/"
          ...
          <a
            href="https://www.linkedin.com/in/mr-ayushgupta/"
            class="btn rounded-0 text-decoration-none w-100 text-white"
            aria-label="LinkedIn"
            style="background-color: var(--primary-color);"
          >
